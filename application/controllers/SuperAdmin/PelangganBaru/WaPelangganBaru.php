...
class WaPelangganBaru extends CI_Controller
{
    ...
    public function followUpAksi($id)
    {
        ...
        $this->load->view('SuperAdmin/PelangganBaru/waPelangganBaru', $data);
    ...
    public function followUpSales()
    {
        ...
        header("location:https://api.whatsapp.com/send?phone=$phone1&text=*INFLY NETWORKS* %0a%0a DATA PELANGGAN BARU %0a%0a Nama : $nama_user %0a Telepon : $tlp_user %0a Alamat : $alamat_user %0a Jenis Paket : $pembelian_paket %0a%0a Terima Kasih.  %0a%0a *INFLY NETWORKS*");
