...
class WaPelangganBaru extends CI_Controller
{
    ...
    public function followUpAksi($id)
    {
        ...
        $this->load->view('Admin/PelangganBaru/waPelangganBaru', $data);
    ...
    public function followUpSales()
    {
        ...
        header("location:https://api.whatsapp.com/send?phone=$phone1&text=*INFLY NETWORKS* %0a%0a DATA PELANGGAN BARU %0a%0a Nama : $nama_customer %0a Telepon : $tlp_customer %0a Alamat : $alamat_customer %0a Jenis Paket : $paket %0a%0a Terima Kasih.  %0a%0a *INFLY NETWORKS*");
