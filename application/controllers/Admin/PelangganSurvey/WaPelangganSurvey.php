...
class WaPelangganSurvey extends CI_Controller
{
    ...
    {
        $data['Follow'] = $this->db->query("SELECT dc.id_customer, dc.paket, dc.nama_customer, dc.nik_customer, dc.alamat_customer, dc.tlp_customer, dc.tanggal, ds.status, dc.id_kota, dk.nama_kota, dc.id_kecamatan, dkec.nama_kecamatan, dc.id_kelurahan, dkel.nama_kelurahan
        ...
        WHERE dc.id_customer=$id")->result();
    ...
    public function followUpSales()
    {
        ...
        $message .= "DATA PELANGGAN SURVEY %0a%0a";
