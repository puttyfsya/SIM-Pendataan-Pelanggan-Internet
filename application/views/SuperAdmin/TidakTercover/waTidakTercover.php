                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <?php foreach ($Follow as $data) : ?>
                                    <form method="POST" action="<?php echo base_url('TidakTercover/WaTidakTercover/followUpSales') ?>">
                                        <div class="row">

                                            <div class="col-md-6 mt-3 col-12">
                                                <div class="form-group">
                                                    <label for="name">Nama</label>
                                                    <input type="text" id="name-column" class="form-control" name="nama_user" value="<?php echo $data->nama_user ?>" readonly>
                                                    <input type="hidden" class="form-control" name="id_user" id="id" value="<?php echo $data->id_user ?>" readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-6 mt-3 col-12">
                                                <div class="form-group">
                                                    <label for="telephone-column">Telephone</label>
                                                    <input type="text" id="telephone-column" class="form-control" name="tlp_user" value="<?php echo $data->tlp_user ?>" readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-6 mt-3 col-12">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6 mt-3 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="alamat" class="form-control" name="alamat_user" value="<?php echo $data->alamat_user ?>" readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-4 mt-3 col-12">
                                                <div class="form-group">
                                                    <label for="paket-column">Paket</label>
                                                    <input type="text" id="paket-column" class="form-control" name="pembelian_paket" value="<?php echo $data->pembelian_paket ?>" readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-4 mt-3 col-12">
                                                <div class="form-group">
