                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="col-12 dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                            ...
                                            <!-- <li><a onclick="return confirm('Yakin Merubah Data')" class="dropdown-item" href="<?php echo base_url('Superadmin/TidakTercover/WaTidakTercover/followUpAksi/' . $data['id_customer']) ?>">Follow-up</a></li> -->
                                        </ul>
                                    </div>
                                </td>
                            </tr>
