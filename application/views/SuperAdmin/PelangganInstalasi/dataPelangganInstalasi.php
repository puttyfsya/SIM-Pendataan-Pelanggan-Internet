                    ...
                    <table class="table table-striped" id="table1">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a onclick="return confirm('Yakin Menghapus Data')" class="btn btn-sm btn-danger" href="<?php echo base_url('PelangganInstalasi/DataPelangganInstalasi/deleteData/' . $data['id_user']) ?>"><i class="bi bi-trash"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
                    </table>
