                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="col-12 dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                            <li><a onclick="" class="dropdown-item" href="<?php echo base_url('PelangganSurvey/EditPelangganSurvey/editData/' . $data['id_user']) ?>">ACC Instalasi</a></li>
                                            <li><a onclick="return confirm('Yakin Merubah Data')" class="dropdown-item" href="<?php echo base_url('PelangganSurvey/EditPelangganSurvey/dataTolak/' . $data['id_user']) ?>">Tidak Tercover</a></li>
                                            <li><a onclick="return confirm('Yakin Menghapus Data')" class="dropdown-item" href="<?php echo base_url('PelangganSurvey/DataPelangganSurvey/deleteData/' . $data['id_user']) ?>">Hapus</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
